...
"{",
	...
	"sinAngle = sin(customAngle);",
	"cosAngle = cos(customAngle);",
...
"{",
	"gl_FragColor = vColor;",
	"vec2 rotatedUV = vec2(cosAngle * (gl_PointCoord.x - 0.5) + sinAngle * (gl_PointCoord.y - 0.5) + 0.5,",
	                      "cosAngle * (gl_PointCoord.y - 0.5) - sinAngle * (gl_PointCoord.x - 0.5) + 0.5);",  // rotate UV coordinates to rotate texture
